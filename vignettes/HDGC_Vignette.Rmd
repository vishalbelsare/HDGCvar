...
vignette: >
  %\VignetteIndexEntry{HDGC_Vignette}
...
`sample_RV` contains 30 Realized Volatility time series of sample T=200 obtined by simulating 30 random instances from a
...
#If you want, you can plot the estimated network.
...
#Uncommment the lines below to make the plot.
set.seed(888)
